...
/**
 * Generates EPC QR Code SVG images from validated data.
 *
 * <p>This generator produces SVG output, which is ideal for:
 * <ul>
 *   <li>Scalable, resolution-independent QR codes</li>
 *   <li>Web and print applications</li>
 *   <li>Easy integration with HTML/CSS</li>
 * </ul>
 *
 * <p>Example usage:
 * <pre>{@code
